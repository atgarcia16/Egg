...
import extra03.Servicios.RaicesServicios;
...
public class Extra03 {
    ...
    public static void main(String[] args) {
        ...
        RaicesServicios srv = new RaicesServicios();
        Raices valor = new Raices();

        srv.cargarEcuacion(valor);
        System.out.println("El valor del discriminante es: " + srv.getDiscriminate(valor));
        srv.calcular(valor);
